...
function _check_prerequisites () {
	...
	printf "LOGFILE GENERATED BY DINNER ${DINNER_VERSION} (https://github.com/NemesisRE/dinner)" &> /dev/null > >( tee -a ${CURRENT_LOG:-${DINNER_LOG_DIR}/dinner_general.log} ${CURRENT_ERRLOG:-${DINNER_LOG_DIR}/dinner_general_error.log} )
